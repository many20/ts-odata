...
describe('tsdata', () => {
  ...
  describe('Format - ', function () {
    it('Atom', function () {
      var j = new Tso('http://foo.bar').format.atom();
      expect(j.toString()).to.equal('http://foo.bar?$format=atom');
    });

    it('Xml', function () {
      var j = new Tso('http://foo.bar').format.xml();
      expect(j.toString()).to.equal('http://foo.bar?$format=xml');
    });

    it('Json', function () {
      var j = new Tso('http://foo.bar').format.json();
      expect(j.toString()).to.equal('http://foo.bar?$format=json');
    });

    it('Custom', function () {
      var j = new Tso('http://foo.bar').format.custom('text/csv');
      expect(j.toString()).to.equal('http://foo.bar?$format=text/csv');
    });

    describe('Default is', function () {
      it('Atom', function () {
        var j = new Tso('http://foo.bar').formatDefault.atom();
        expect(j.toString()).to.equal('http://foo.bar?$format=atom');
      });

      it('Xml', function () {
        var j = new Tso('http://foo.bar').formatDefault.xml();
        expect(j.toString()).to.equal('http://foo.bar?$format=xml');
      });

      it('Json', function () {
        var j = new Tso('http://foo.bar').formatDefault.json();
        expect(j.toString()).to.equal('http://foo.bar?$format=json');
      });

      it('Custom', function () {
        var j = new Tso('http://foo.bar').formatDefault.custom('text/csv');
        expect(j.toString()).to.equal('http://foo.bar?$format=text/csv');
      });
    });
  ...
  describe('Inline Count - ', function () {
    it('All Pages', function () {
      var j = new Tso('http://foo.bar').inlineCount.allPages();
      expect(j.toString()).to.equal('http://foo.bar?$inlinecount=allpages');
    });

    it('None', function () {
      var j = new Tso('http://foo.bar').inlineCount.none();
      expect(j.toString()).to.equal('http://foo.bar?$inlinecount=none');
    });

    describe('Default is', function () {
      it('All Pages', function () {
        var j = new Tso('http://foo.bar').inlineCountDefault.allPages();
        expect(j.toString()).to.equal('http://foo.bar?$inlinecount=allpages');
      });

      it('None', function () {
        var j = new Tso('http://foo.bar').inlineCountDefault.none();
        expect(j.toString()).to.equal('http://foo.bar?$inlinecount=none');
      });
    });
  ...
  describe('Filter', function () {
    describe('Building and/or Filters', function () {
      ...
      it('multiple and filters', function () {
        var j = new Tso('http://foo.bar');
        j.andFilter(new FilterClause('Property1').eq(5))
      ...
      it('multiple or filters', function () {
        var j = new Tso('http://foo.bar');
        j.orFilter(new FilterClause('Property1').eq(5))
      ...
      describe('Default Filters', function () {
        ...
        it('multiple and filters', function () {
          var j = new Tso('http://foo.bar');
          j.defaultAndFilter(new FilterClause('Property1').eq(5))
        ...
        it('multiple or filters', function () {
          var j = new Tso('http://foo.bar');
          j.defaultOrFilter(new FilterClause('Property1').eq(5))
        ...
        it('mixing defaults and normal filters', function () {
          var j = new Tso('http://foo.bar');
          j.defaultFilter(new FilterClause('Id').eq(1))
    ...
    describe('Removing Single Filters', function () {
      ...
      it('removing a logical operator filter', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('CustomerName').eq('bob'))
          .andFilter(new FilterClause('CustomerId').eq(1));
      ...
      it('removing a arithmetic method filter', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('CustomerName').eq('bob'))
          .andFilter(new FilterClause('Price').add(5).eq(1));
      ...
      it('removing string function filter', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('CustomerName').eq('bob'))
          .andFilter(new FilterClause('Title').substringof('bob').eq(true));
      ...
      it('removing date function filter', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('CustomerName').eq('bob'))
          .andFilter(new FilterClause('Birthday').day().eq(2));
      ...
      it('removing math function filter', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('CustomerName').eq('bob'))
          .andFilter(new FilterClause('Price').round().eq(2));
    ...
    describe('Precedence Groups', function () {
      ...
      it('mixing precedence groups', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('Id').eq(1))
    ...
    describe('String Functions', function () {
      ...
      it('Substringof - with toLower', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('PropertyName').toLower().substringof('test').eq(true));
      ...
      it('Substringof - with toUpper', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('PropertyName').toUpper().substringof('test').eq(true));
      ...
      it('Substringof - with trim', function () {
        var j = new Tso('http://foo.bar');
        j.filter(new FilterClause('PropertyName').trim().substringof('test').eq(true));
